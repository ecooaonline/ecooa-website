...
export const GET: APIRoute = async () => {
  ...
  const feed = {
    ...
    description:
      'Saúde, estética e longevidade que conversam entre si. Artigos por especialistas da ecooa em Porto Alegre.',
    language: 'pt-BR',
    ...
    items: posts.map((post) => ({
      ...
      ...(post.data.lastModified && {
        date_modified: new Date(post.data.lastModified).toISOString(),
      }),
