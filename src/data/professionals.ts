...
export const professionals: Professional[] = [
  ...
  {
    slug: 'eduarda-schoenmeier',
    name: 'Eduarda Schoenmeier',
    role: 'Biomédica · Estética Facial e Corporal',
    unit: 'esthetic',
    photo: '',
    registration: 'CRBM 7243',
    description: 'Biomédica esteta com atuação em harmonização facial e corporal.',
    tags: ['Harmonização Facial', 'Estética Corporal'],
  },
  {
    slug: 'tais-de-la-rosa',
    name: 'Tais de la Rosa',
    role: 'Farmacêutica · Skin Expert',
    unit: 'esthetic',
    photo: '',
    description: 'Farmacêutica com atuação em estética e cuidados com a pele, com embasamento científico.',
    tags: ['Pele', 'Skincare', 'Estética'],
  },
  {
    slug: 'jessica-stein',
    name: 'Jessica Stein',
